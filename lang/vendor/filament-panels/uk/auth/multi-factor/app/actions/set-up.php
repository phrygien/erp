...
return [
    ...
    'modal' => [
        ...
        'description' => <<<'BLADE'
            Для завершення цього процесу вам знадобиться додаток, наприклад Google Authenticator (<x-filamentOld::link href="https://itunes.apple.com/us/app/google-authenticator/id388497605" target="_blank">iOS</x-filamentOld::link>, <x-filamentOld::link href="https://play.google.com/store/apps/details?id=com.google.android.apps.authenticator2" target="_blank">Android</x-filamentOld::link>).
            BLADE,
