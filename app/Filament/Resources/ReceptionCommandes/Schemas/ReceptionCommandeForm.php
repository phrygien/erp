        ...
        return $schema
            ->components([
                Wizard::make([
                    Step::make('Commande liée')
                        ...
                        ->components([
                            ...
                            TextInput::make('numero_bl')
                                ...
                                ->default(fn (?ReceptionCommande $record) => $record?->numero_bl
                                    ?? ReceptionCommande::previewProchainNumeroBl())
                                ->disabled()
                                ->dehydrated(false)
                                ->helperText('Généré automatiquement'),
                        ]),

                    Step::make('Suivi de la réception')
                    ...
                    Step::make('Détail de la réception')
